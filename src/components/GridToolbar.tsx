...
interface GridToolbarProps {
  ...
  /** Show a red unread-dot on the alerts bell (e.g. a new Next-Best-Action agent alert). */
  hasNewAlert?: boolean;
  ...
  return (
    <div className="grid-toolbar">
      ...
      <div className="grid-button-group">
        ...
        <button className={`grid-button-group-item ${isAlertActive ? 'active' : ''}`} title="Status" onClick={onAlertClick} style={{ position: 'relative' }}>
          <svg fill="currentColor" viewBox="0 0 520 520" width="16" height="16" aria-hidden>
          ...
          {hasNewAlert && <span className="alert-bell-dot" aria-label="New alert" />}
        </button>
      </div>
